...
class ModeloTestaction{
	...
	static public function mdlIngresarTestaction($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_evento, id_test, id_test_opcion, id_usuario, text) VALUES (:id_evento, :id_test, :id_test_opcion, :id_usuario, :text)");
	...
	static public function mdlEditarTestaction($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_evento = :id_evento, id_test = :id_test, id_test_opcion = :id_test_opcion, id_usuario = :id_usuario WHERE id = :id");
